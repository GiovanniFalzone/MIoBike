...
public class Constants extends Constants_om2m{
	...
	public static final boolean DEV_MODE_0	= true;
	public static final boolean DEV_MODE_1	= true;
	public static final boolean DEV_MODE_IN	= true;
	public static final boolean DEV_MODE_MN = true;
	public static final boolean DEV_MODE_BM = true;
