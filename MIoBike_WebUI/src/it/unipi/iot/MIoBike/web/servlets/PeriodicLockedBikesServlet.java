...
/**
 * Servlet implementation class PeriodicLockedBikeServlet
 * It get locked bikes from oM2M, periodically with a period of 10 seconds, and notify user-section.
 */
@WebServlet("/PeriodicLockedBikesServlet")
public class PeriodicLockedBikesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
    
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PeriodicLockedBikesServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//JSONArray data = bm.get_Bikes_Data();
		String data = "request";
